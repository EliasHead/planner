...
export function App() {
  return (
    <div className="h-screen flex items-center justify-center">
      <div className="max-w-full px-6 text-cente space-y-10">
        ...
        <p className="text-sm text-zinc-500">
          ...
          com nosso <a className="text-zinc-300 underline" href="#"> termos de uso</a> e <a className="text-zinc-300 underline" href="#">politicas de privacidade</a> .
        </p>
      </div>
    </div>
  )
